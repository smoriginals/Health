                ...
                >
                    {questions.map((item, i) => (
                        <div
                            ...
                            className="flex w-80 flex-shrink-0 cursor-pointer flex-col rounded-2xl border border-gray-100 bg-white p-5 shadow-lg transition hover:-translate-y-1 hover:shadow-md"
                        >
                            {/* Icon + Question */}
