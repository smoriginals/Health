...
function SurgeryHero() {
    return (
        <div className="relative top-16 bg-gradient-to-b from-blue-50 to-white py-6">
        ...
        <div className="bg-white py-12">
            <div className="mx-auto max-w-6xl px-4">
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                    {types.map((t) => (
                        <div key={t.id} className="rounded-lg border border-gray-200 p-6 shadow-sm transition hover:shadow-md">
            ...
            <div className="mx-auto max-w-6xl px-4">
                ...
                <div className="space-y-4">
                    {timeline.map((phase, idx) => (
                        <div key={idx} className="flex gap-4 rounded-lg border border-gray-200 p-4 transition hover:shadow-md">
                            <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-teal-600 font-bold text-white">
                                {idx + 1}
                            </div>
                            <div>
